...
export const pageSections: { [key: string]: PageSection } = {
  ...
  'pageSection->meals->spoon-dishes-1': {
    ...
    active: true,
    template: 'template->pageSection->two-rows-multi-col->single-col-list',
    defaultImg: 'image->section->aside-1500-450-default',
    mainImg: 'image->section->aside-1500-450-spoon-dishes',
    show: true,
    showExtraInfo: false,
    showDescription: false,
    showTitle: false,
  ...
  'pageSection->meals->prime-cut-meats-1': {
    id: 'pageSection->meals->prime-cut-meats-1',
    type: 'section',
    active: true,
    template: 'template->pageSection->two-rows-multi-col->single-col-list',
    defaultImg: 'image->section->aside-1500-400-default',
    mainImg: 'image->section->aside-1500-400-prime-cut-meats',
    show: true,
    showExtraInfo: false,
    showDescription: false,
    showTitle: false,
    listItemsForCol: 6,
    lists: ['list->meals->prime-cut-meats'],
    number: '1',
    displayInfo: {
      es: {
  ...
  'pageSection->meals->fresh-pasta-1': {
    id: 'pageSection->meals->fresh-pasta-1',
    type: 'section',
    active: true,
    template: 'template->pageSection->two-rows-multi-col->single-col-list',
    defaultImg: 'image->section->aside-1500-400-default',
    mainImg: 'image->section->aside-1500-400-fresh-pasta',
    show: true,
    showExtraInfo: false,
    showDescription: false,
    showTitle: false,
    listItemsForCol: 6,
    lists: ['list->meals->fresh-pasta'],
    number: '1',
    displayInfo: {
      es: {
        title: 'Pasta Fresca',
  ...
  'pageSection->wines-3': {
    ...
    showTitle: false,
    listItemsForCol: 4,
    lists: ['list->wines->rose-wines', 'list->wines->sangrias-and-champagnes'],
    number: '3',
    displayInfo: {
      es: {
        title: 'Vinos',
  ...
  'pageSection->wines-4': {
    id: 'pageSection->pageSection->wines-4',
    type: 'section',
    active: true,
    template: 'template->pageSection->one-row-two-cols->slide',
    defaultImg: 'image->section->aside-650-750-default',
    mainImg: 'image->section->aside-650-750-red-wine-2',
    show: true,
    showExtraInfo: false,
    showDescription: false,
    showTitle: false,
    listItemsForCol: 10,
    lists: ['list->wines->red-wines-2'],
    number: '1',
    displayInfo: {
      es: {
        title: 'Vinos',
